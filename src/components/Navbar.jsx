          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <form classNameName="d-flex" role="search">
              <div classNameName={`form-check form-switch text-${props.mode === 'light' ? 'dark': 'light' }`}>
                <input classNameName="form-check-input" type="checkbox" role="switch" id="flexSwitchCheckDefault" onClick={props.toggleMode} onChange={props.toggleMode1}/>{props.btntext}
              </div>
            </form>
          </div>
        </div>
